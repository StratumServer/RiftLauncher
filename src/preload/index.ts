...
const api: BridgeAPI = {
  ...
  backgroundsManager: {
    ensureBackground: (id: string, file: string, sha256?: string): Promise<{ refreshed: boolean }> => ipcRenderer.invoke(IPC_CHANNELS.BACKGROUNDS_MANAGER.ENSURE_BACKGROUND, id, file, sha256),
